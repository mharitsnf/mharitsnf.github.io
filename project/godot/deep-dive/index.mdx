...
import gameplay from "./deep-dive-gameplay.mp4"
...
<Flex>
    <NavLinkOut target="https://github.com/mharitsnf/DeepDiveGame" >Github</NavLinkOut>
    <NavLinkOut target="https://arsith.itch.io/deep-dive" >Play the game</NavLinkOut>
</Flex>
...
which was my second game jam. The player must escape underwater dungeons along with the treasure. 
Whenever the character carries the treasure, the character sinks, but whenever they are not, they will float.

---

## Design
The jam comes with a theme **"deeper and deeper"** and can be freely interpreted by the participants. 
