...
## Overview
Run Guys is an competitive endless runner game played through both VR and a mobile application. The mobile players must
survive by avoiding obstacles and the longest to survive wins the game. The obstacles are placed by the VR player, who is
